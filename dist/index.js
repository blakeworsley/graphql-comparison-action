...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const localSchemaPath = core.getInput('local-schema-path');
            const remoteSchemaEndpoint = core.getInput('remote-schema-endpoint');
            const remoteSchemaAuthToken = core.getInput('remote-schema-auth_token');
